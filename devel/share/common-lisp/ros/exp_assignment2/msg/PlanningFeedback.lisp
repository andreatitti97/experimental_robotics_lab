...
(cl:defmethod cl:initialize-instance :after ((m <PlanningFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlanningFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name exp_assignment2-msg:<PlanningFeedback> is deprecated: use exp_assignment2-msg:PlanningFeedback instead.")))

(cl:ensure-generic-function 'stat-val :lambda-list '(m))
(cl:defmethod stat-val ((m <PlanningFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exp_assignment2-msg:stat-val is deprecated.  Use exp_assignment2-msg:stat instead.")
  (stat m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <PlanningFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exp_assignment2-msg:position-val is deprecated.  Use exp_assignment2-msg:position instead.")
  (position m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PlanningFeedback>)))
  ...
  "exp_assignment2/PlanningFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PlanningFeedback)))
  "Returns string type for a message object of type 'PlanningFeedback"
  "exp_assignment2/PlanningFeedback")
