...
"""autogenerated by genpy from exp_assignment2/PlanningActionResult.msg. Do not edit."""
import codecs
import sys
...
class PlanningActionResult(genpy.Message):
  ...
  _type = "exp_assignment2/PlanningActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','exp_assignment2/PlanningResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = exp_assignment2.msg.PlanningResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = exp_assignment2.msg.PlanningResult()
